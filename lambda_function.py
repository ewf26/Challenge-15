...
def recommend_portfolio(intent_request):
    ...
    validate_data(age,investment_amount)
    get_risk_level(risk_level)
...
def get_risk_level(risk_level):
    if risk_level == 'None':
        ...
        return 'Please input valid risk level'
    ...
    if age is not None:
        ...
        if age <=0 or age >= 65:
            return build_validation_result(
                False,
                "age",
                "age should be greater than 0 or less than 65",)
    ...
    if investment_amount is not None:
        ...
        if investment_amount <=5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "investment amount must be greater than or equal to 5000 dollars,")
